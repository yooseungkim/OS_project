...
\title{Operation System Project 3 (Team \#2)}
...
\subsubsection{Resource Cleanup and Runtime Configuration}
...
마지막으로 \codefont{pintos/src/utils/pintos}와 \codefont{pintos/src/utils/Pintos.pm}의 기본 kernel 및 loader 경로를 \codefont{threads/build}에서 \codefont{userprog/build}로 변경하였다. Project 3의 \codefont{make check}는 \codefont{pintos/src/userprog} 기준으로 실행되므로, 이 설정을 바꾸어야 user program 테스트가 Project 3에서 빌드한 kernel과 loader를 사용한다.
...
\begin{figure}[htbp]
    ...
    \IfFileExists{result.png}{%
        ...
        \fbox{\parbox{0.9\linewidth}{\centering \codefont{result.png}}}%
    }
    \caption{Project3 Result}
    \label{fig:project3-result}
\end{figure}
